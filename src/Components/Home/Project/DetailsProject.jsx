...
const DetailsProject = () => {
  ...
  return (
    <Content>
      <div className="md:pt-7 pt-5 pb-7  text-white">
        ...
        >
          {currentProject?.othersImage.map((images) => (
            <SwiperSlide key={images.name} className="px-5 md:px-0">
              <section className="max-w-5xl rounded-xl mx-auto bg-[#242F48] py-5 flex items-center flex-col">
                <div>
        ...
        <div className="md:pt-20 pt-10">
          ...
          <div className="flex items-center gap-4 pt-7">
            ...
            >
              <button className="flex items-center gap-2 text-white  selectSmallButton md:selectButton">
                <IoIosLink size={25} />
